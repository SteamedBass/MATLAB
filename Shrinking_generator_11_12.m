...
for n = 1 : N1
    temp = xor(M(11), M(9));               % alter
    
    Sequence1(n)=M(11);                 % alter
...
M(10)=0;
M(11)=0;
M(12)=1;                                  % alter  % start from here

Sequence2=[];  %Initiation
for m= 1 : N2
    
    temp=xor(xor(xor(M(12), M(11)),M(7)),M(4));
    Sequence2(m)=M(12);      % alter
